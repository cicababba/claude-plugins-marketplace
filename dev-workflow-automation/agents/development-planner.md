...
>      **Project Context:** Follow form patterns from existing codebase. Use CVA for component variants. Maintain existing Italian language support. **Return Format (MANDATORY):** Respond with **only** the JSON completion ticket below (no extra text).
>
> ```json
> {
>   "stepId": "step-006",
